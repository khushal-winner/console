...
const KNOWN_ROUTES: KnownRoute[] = [
  ...
  { href: '/multi-tenancy', name: 'Multi-Tenancy', description: 'Tenant isolation with OVN-Kubernetes, KubeFlex, K3s, and KubeVirt', icon: 'KubernetesWheel', category: 'Core Dashboards' },
  // Resource Pages
